        ...
        <>
            ...
            <div style={{ "backgroundColor": "#090A1A" }}>
                ...
                <div class='wrap z-20 w-[100vw] h-[100vh]'>
                    ...
                    bg-gradient-to-r from-blue-200 via-blue-500 to-green-200 orbi font-extrabold text-base md:text-xl cursor-not-allowed">
                            Register
                ...
                <div className=" relative -top-48 z-[50]">
                    ...
                    <div>
                        ...
                        > */}
                           ...
                           bg-gradient-to-r from-blue-200 via-blue-500 to-purple-200 orbi font-extrabold text-base md:text-xl cursor-not-allowed">
                                Register
                            </button>
                            {/* </a> */}
                    ...
                    ></iframe>
                        ...
                        > */}
                            ...
                            {/* <button className="festButton mt-5 text-2xl md:text-3xl lg:text-4xl cursor-not-allowed">
                                {"Register Now!"}
                            </button> */}
                            {/* </a> */}
                ...
                <div className="relative bottom-24  flex justify-center items-center my-10 flex-col">
                 ...
                 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 orbi font-extrabold text-base md:text-xl cursor-not-allowed">
                        Register
                    </button>
                    {/* </a> */}
    ...
    return (
        <div className={"w-[100vw] h-[100vh] absolute top-0 left-0 z-[10000] overflow-hidden grid place-items-center cursor-default bg-[#00000089]"}>
            ...
            <div className={" mt-6 z-[1100] relative w-[90vw] mx-auto md:w-[32rem] h-fit bg-[#ffffff]  rounded-lg shadow-lg flex flex-col justify-start items-center gap-10 px-6 py-10 mobile:w-[17.5rem]"}>
                <button
                    type="button"
                    className="cursor-pointer absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
