...
export default function List({ day, date, topic, session, notes, rec, assign, pp }) {
    ...
    return (
        <>
            <li class="ml-4 ">
                ...
                <time class="mb-1 text-md font-normal leading-none text-gray-50 dark:text-gray-500">{day} </time>
                <h3 onClick={() => { setIsOpen(e => !e) }} class="cursor-pointer text-3xl font-semibold text-blue-700 dark:text-white">{topic}</h3>
                {isOpen &&
                    <div className='mt-2'>
